      ...
      {!open ? (
        ...
        <div className="space-y-3 text-xs text-slate-500">
          ...
          <ol className="space-y-2">
            <li>
              <span className="mr-1.5 font-semibold text-slate-700">1.</span>
              컴퓨터 크롬에서 즐겨찾기 막대를 켭니다 —{" "}
              <span className="text-slate-600">Ctrl+Shift+B</span> (맥은{" "}
              <span className="text-slate-600">⌘+Shift+B</span>). 주소창 아래
              한 줄이 생깁니다.
            </li>
            <li>
              <span className="mr-1.5 font-semibold text-slate-700">2.</span>
              아래 파란 버튼을{" "}
            ...
            <li>
              <span className="mr-1.5 font-semibold text-slate-700">3.</span>
              끝났습니다. 이제 인스타그램에서 마음에 드는 크리에이터{" "}
              <strong className="text-slate-700">프로필 화면</strong>을 열고
          ...
          <div className="border-t border-slate-200 pt-2.5">
            ...
            <button
              type="button"
              onClick={copyCode}
              className="rounded-lg border border-slate-300 px-2.5 py-1 text-[11px] text-slate-600 hover:text-slate-900"
            >
